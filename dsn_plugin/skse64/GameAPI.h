...
public:
	...
	DEFINE_MEMBER_FN(Allocate, void *, 0x00C3A890, size_t size, size_t alignment, bool aligned);
	DEFINE_MEMBER_FN(Free, void, 0x00C3AB90, void * buf, bool aligned);
};
...
public:
	...
	DEFINE_MEMBER_FN(VPrint, void, 0x00884ED0, const char * fmt, va_list args);
