...
public:
	...
	DEFINE_MEMBER_FN(SetCameraState, UInt32, 0x00505CB0, TESCameraState * cameraState);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x00205C40);
	DEFINE_MEMBER_FN(SetNorthRotation, void, 0x00206000, float northRotation);
};
...
public:
	...
	static PlayerCamera *	GetSingleton(void)
	{
		...
		static RelocPtr<PlayerCamera*> g_playerCamera(0x02F85778);
	...
	DEFINE_MEMBER_FN(UpdateThirdPerson, void, 0x00875E90, bool weaponDrawn);
};
