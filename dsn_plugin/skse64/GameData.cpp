...
RelocPtr <DataHandler *> g_dataHandler(0x01F7D9D8);

// 5F417CF4D2EB33C7D6903EA38BB5CDDEF48A6F83+4B
RelocPtr <PersistentFormManager *> g_persistentFormManager(0x01F7E0C8);

// AABE5E29A00767351E81AE6945D505F2BF264D45+60
RelocPtr <FaceGen *> g_faceGen(0x01F7E120);

// 6F7C1B16C6DF82EB76AEECA5A719A0A1EC196C45+28
RelocPtr<MagicFavorites *>	g_MagicFavorites(0x02FE6108);

// C744C8E2830617136B1E2036CE7FAA915F0BB6FF+1D
RelocPtr<MenuTopicManager *> g_MenuTopicManager(0x02FBF768);

// 72603162CC51078584DECEF18ACB8B61C91A63FC+86
RelocPtr <ActorValueList *> g_actorValueList(0x01F7D9C8);

// aWerewolfSpell
RelocPtr <DefaultObjectList> g_defaultObjectList(0x01E6DEC0);

// 2A6F38D8E37578F4C502298F6730695E0AF4213C+84
RelocPtr <BGSSaveLoadManager *> g_saveLoadManager(0x02FE6118);

// 3A2D747A1809205B8E28BD34724286AF76CF511B+2A
RelocPtr <MiscStatManager>	g_MiscStatManager(0x02F85298);

// A9D0A72CC9E5F85E2169118F999943FD43AF51EA+95
RelocPtr <EquipManager *> g_equipManager(0x02F845C8);

// 60C21F969EDFE69EBC96CEEF9620AAF752E2E28B+2
RelocPtr <RelationshipRanks> g_relationshipRanks(0x01E8C1B8);

RelocAddr<_ChangeActorHeadPart> ChangeActorHeadPart(0x003EBA80);
// E596A4244F8A3A25FD8DB7E62A3904933060BEA8+DD
RelocAddr<_GetEitherHandSlot> GetEitherHandSlot(0x00340C30);
// A57D77CB5250B7D84828312B34413A9123EDDD53+35
RelocAddr<_GetRightHandSlot> GetRightHandSlot(0x00340C00);
// A9D0A72CC9E5F85E2169118F999943FD43AF51EA+83
RelocAddr<_GetLeftHandSlot> GetLeftHandSlot(0x00340BD0);
RelocAddr<_LookupActorValueByName> LookupActorValueByName(0x003F0B50);
// 0A2FCE1738344AE17FCD2B406BDCAAD46AA64394+E4
RelocAddr<_UpdatePlayerTints> UpdatePlayerTints(0x008DFC00);
RelocAddr<_GetActorBaseOverlays> GetActorBaseOverlays(0x003781B0);
RelocAddr<_GetNumActorBaseOverlays> GetNumActorBaseOverlays(0x00378240);

RelocAddr<_ApplyMasksToRenderTarget> ApplyMasksToRenderTarget(0x003EAAF0);

// 0A2FCE1738344AE17FCD2B406BDCAAD46AA64394+DC | +1A
RelocAddr<_UpdateModelSkin> UpdateModelSkin(0x003EBDE0); // Applies tint to ShaderType 5 nodes
// BFB8C9723EF563C7B5A0E336C4A44311725F8047+F4 | +1A
RelocAddr<_UpdateModelHair> UpdateModelHair(0x003EBEA0); // Applies tint to ShaderType 6 nodes
RelocAddr<_UpdateModelFace> UpdateModelFace(0x003EB460);
RelocAddr<_UpdateHarvestModel> UpdateHarvestModel(0x001AC9F0);

RelocAddr<_GetRelationshipIndex> GetRelationshipIndex(0x003554B0);

// C5B21010DCF340FCDDDC7866C50C3D78AEF34CB5+6B
//RelocPtr <bool> g_isGameDataReady(0x058FEAB4);

RelocAddr<_HasLOS> HasLOS(0x00954550);
