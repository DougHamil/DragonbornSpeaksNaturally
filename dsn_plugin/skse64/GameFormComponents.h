...
public:
	...
	DEFINE_MEMBER_FN(Get, void, 0x001A0020, BSString * out, TESForm * parent, UInt32 fieldType);
};
...
public:
	...
	DEFINE_MEMBER_FN(UpdateWeightData, void, 0x001D63A0);
	DEFINE_MEMBER_FN(DeleteThis, void, 0x001D6070);
};
...
public:
	...
	DEFINE_MEMBER_FN(SetEquipFlag, void, 0x00687690, UInt8 flags);
	DEFINE_MEMBER_FN(UpdateEquipment, void, 0x00659FA0, Actor * actor);
	// FBB0A4AE04B0C1C63470C26B004079D7D9B20D0B+8B
	DEFINE_MEMBER_FN(SetDataFlag, void, 0x00665A30, float flag); // Sets a number on the 0x10 object. SE: The parameter flag was actually a float (xmm1)
...
public:
	...
	DEFINE_MEMBER_FN(GetSkillData, UInt32, 0x0070B650, UInt32 actorValue, float * level, float * points, float * pointsMax, UInt32 * unk6);
	DEFINE_MEMBER_FN(IncrementLegendary, UInt32, 0x0070BB40, UInt32 actorValue);
	DEFINE_MEMBER_FN(SetLevel, void, 0x0070BAE0, UInt32 level);
};
