...
InputEventDispatcher* InputEventDispatcher::GetSingleton()
{
	...
	static RelocPtr<InputEventDispatcher*> g_inputEventDispatcher(0x02FE5410);
...
InputManager * InputManager::GetSingleton(void)
{
	...
	static RelocPtr<InputManager*> g_inputManager(0x02F85990);
...
PlayerControls * PlayerControls::GetSingleton(void)
{
	...
	static RelocPtr<PlayerControls*> g_playerControls(0x02F85998);
...
MenuControls * MenuControls::GetSingleton(void)
{
	...
	static RelocPtr<MenuControls*> g_menuControls(0x02FC01D8);
