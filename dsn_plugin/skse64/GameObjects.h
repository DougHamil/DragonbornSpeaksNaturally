...
public:
	...
	DEFINE_MEMBER_FN(ctor, BSShaderTextureSet *, 0x01303CA0);
};
...
public:
	...
	DEFINE_MEMBER_FN(GetCostliestEffectItem, EffectItem *, 0x001120E0, int arg1, bool arg2);
	DEFINE_MEMBER_FN(GetEffectiveMagickaCost, float, 0x00111E50, Character* caster);
};
...
public:
	...
	DEFINE_MEMBER_FN(GetSex, char, 0x00360880);
	DEFINE_MEMBER_FN(HasOverlays, bool, 0x003780A0);

	// Swaps a headPart of the same type as target with target
	DEFINE_MEMBER_FN(ChangeHeadPart, void, 0x00375270, BGSHeadPart * target);
	...
	DEFINE_MEMBER_FN(UpdateNeck, void, 0x0036FCF0, BSFaceGenNiNode * faceNode);

	// Computes RGB SkinTone from RGBA TintMask
	// C74DE866EA2CBFADF8A164FC95A889A9DBA09091+C7
	DEFINE_MEMBER_FN(SetSkinFromTint, void, 0x0036FAA0, NiColorA * result, TintMask * tintMask, UInt32 compute, UInt32 unk1);
