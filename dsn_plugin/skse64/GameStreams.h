...
public:
	...
	DEFINE_MEMBER_FN(Construct, NiMemStream *, 0x01356FE0);
	DEFINE_MEMBER_FN(Destroy, void, 0x01357050);
	DEFINE_MEMBER_FN(Seek, void, 0x013570E0, SInt32);
	// ??_7NiMemStream@@6B@ + 18
	DEFINE_MEMBER_FN(GetOffset, UInt32, 0x00C66FB0, void);
	DEFINE_MEMBER_FN(CopyFrom, UInt32, 0x013570B0, void *);
	// ??_7NiMemStream@@6B@ + 28
	DEFINE_MEMBER_FN(FunctionSwap, UInt32, 0x01357120, bool);
...
public:
	...
	DEFINE_MEMBER_FN(Construct, BSResourceNiBinaryStream *, 0x00CB8E50, const char * filePath, UInt32 unk1, UInt32 unk2);	// unk1 = 0, unk2 = 0
	DEFINE_MEMBER_FN(ReadLine, UInt32, 0x00CB93B0, char * dst, UInt32 dstLen, UInt32 terminator);
	...
	DEFINE_MEMBER_FN(Read, UInt32, 0x00CB95A0, void * dst, UInt32 len);
	// E93F9EA10EEEC2FC86D868E75F28A023D7453255+5C
	DEFINE_MEMBER_FN(Write, UInt32, 0x00CB9610, void * src, UInt32 len);
	DEFINE_MEMBER_FN(Destroy, void, 0x00CB9130);

	DEFINE_MEMBER_FN(IsValid, bool, 0x00CB9270, void);
	DEFINE_MEMBER_FN(Seek, void, 0x00CB9280, SInt32);
	// ??_7BSResourceNiBinaryStream@@6B@ + 18
	DEFINE_MEMBER_FN(GetOffset, UInt32, 0x00CB92D0, void);	// return offset;
	// ??_7BSResourceNiBinaryStream@@6B@ + 28
	DEFINE_MEMBER_FN(EnableEndianSwap, void, 0x00CB9370, bool);
