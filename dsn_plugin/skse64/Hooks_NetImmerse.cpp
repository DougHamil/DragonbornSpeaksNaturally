...
RelocPtr<UInt32> g_tintTextureWidth(0x03180708);
// 799F89E4A13D41B1F88644E1F6AFA5A633684C51+33E
RelocPtr<UInt32> g_tintTextureHeight(0x0318070C);
...
RelocAddr<_CreateRenderTarget> CreateRenderTarget(0x00DC43B0);
...
RelocAddr <uintptr_t> UpdateEquipment_Enter(0x0069C550 + 0x189);
