...
//	void						** _vtbl;		// 00
	...
	DEFINE_MEMBER_FN(ctor_data, StandardItemData *, 0x0087D300, GFxMovieView ** movieView, InventoryEntryData * objDesc, UInt64 unk);
	...
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x0087E4F0 + 0x97);
...
//	void			** _vtbl;	// 00
	...
	DEFINE_MEMBER_FN(ctor_data, MagicItemData *, 0x008CAB00, GFxMovieView ** movieView, TESForm * pForm, int unk); // unk is ignored by ctor

	static uintptr_t GetCtorHookAddress()
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x008CBEC0 + 0x97);
		return kCtorHookAddress.GetUIntPtr();
	}
...
namespace favMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetItemData_Base(0x008A2680);
	...
	// 2 - Magic
	RelocAddr<uintptr_t> kSetMagicData_Base(0x008A35D0);
	...
	// 3 - VampireLord
	RelocAddr<uintptr_t> kSetVampireData_Base(0x008A39A0);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x0088E2C0);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x0088E170);
	...
	{
		static RelocAddr<uintptr_t> SetData_Hooked_Address(0x00899DA0);
...
namespace craftingMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetData_Base(0x0088E560);
	...
	{
		static RelocAddr<uintptr_t> SetData_Hooked_Address(0x00899A30);
...
namespace alchemyMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetData_Base(0x0088E410);
	...
	{
		static RelocAddr<uintptr_t> SetData_Hooked_Address(0x00899B90);
		((_SetData_Hooked)(SetData_Hooked_Address.GetUIntPtr())) (dataContainer, entry, menu);
	}
	...
	RelocAddr<uintptr_t> kExtendCategoryArgs_Base(0x0089AD00);
...
RelocAddr <uintptr_t> kInstallHooks_Enter(0x00F27F10 + 0x1D9);
