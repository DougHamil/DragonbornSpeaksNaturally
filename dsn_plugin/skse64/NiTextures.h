...
public:
	...
	DEFINE_MEMBER_FN(UpdateVirtualImage, void, 0x00F276D0, NiRenderedTexture * newTexture);
	DEFINE_MEMBER_FN(AddVirtualImage, UInt8, 0x00F27790, BSFixedString linkageName);
	DEFINE_MEMBER_FN(ReleaseVirtualImage, void, 0x00F27660);
};
