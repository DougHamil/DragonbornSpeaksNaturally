...
#define SKSE_VERSION_VERSTRING		"0, 2, 0, 8"
#define SKSE_VERSION_PADDEDSTRING	"0001"
#define SKSE_VERSION_RELEASEIDX		57
...
#define CURRENT_RELEASE_RUNTIME		RUNTIME_VR_VERSION_1_3_64
#define CURRENT_RELEASE_SKSE_STR	"2.0.8"
