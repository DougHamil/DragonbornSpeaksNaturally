...
public:
	...
	DEFINE_MEMBER_FN(Allocate, void *, 0x00C02450, size_t size, size_t alignment, bool aligned);
	DEFINE_MEMBER_FN(Free, void, 0x00C02750, void * buf, bool aligned);
};
...
public:
	...
	DEFINE_MEMBER_FN(VPrint, void, 0x0085C4B0, const char * fmt, va_list args);
