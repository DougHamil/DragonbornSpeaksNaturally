...
public:
	...
	DEFINE_MEMBER_FN(ctor, NiStream *, 0x00C593D0);
	DEFINE_MEMBER_FN(dtor, void, 0x00C59630);
	DEFINE_MEMBER_FN(AddObject, void, 0x00C59820, NiObject * object);
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x0014CE10);
...
public:
	...
	DEFINE_MEMBER_FN(SaveStream, bool, 0x00C59C50, char ** buffer, UInt32 * length);
	DEFINE_MEMBER_FN(LoadStream, bool, 0x00C59C00, char * buffer, UInt32 length);
};
